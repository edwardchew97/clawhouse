...
See [AGENTS.md](./AGENTS.md) for behavioral guidelines and current project scope.

For product or implementation decisions, read these first:
...
- [truth/agent-board-ledger-scope.md](./truth/agent-board-ledger-scope.md)
