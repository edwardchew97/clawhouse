...
- Do not perform active implementation, product writing, proof generation, experiments, branch work, or scratch work in the main checkout. All active work must happen in a dedicated task worktree under `.worktrees/<branch-or-task-name>`.
...
- Create ClawHouse worktrees inside this repo at `.worktrees/<branch-or-task-name>`; do not create them beside this repo in its parent directory or in any other external directory.
